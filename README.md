...
| Validation | `lyric_genre_val_MIT.csv` | 16332 |
| Test | `lyric_genre_test_MIT.csv` | 17745 |
...
| Model 2 — Transfer Learning: Frozen GloVe | 66.96% | .763 |
| Model 3 — Transfer Learning: Fine-tuned GloVe | 71.35% | .685 |
