...
implementing TensorFlow/Keras to develop a NLP pipeline that predicts **the music genre of a sing based on its lyrics** using neural text vectorization, neural network classification and word embedding techniques. 
