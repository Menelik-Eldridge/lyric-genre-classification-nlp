...
***Predicting the music genre of a sing based on its lyrics*** by implementing TensorFlow/Keras to develop a NLP pipeline that uses neural text vectorization, neural network classification and word embedding techniques. 
